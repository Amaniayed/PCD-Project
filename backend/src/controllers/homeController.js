...
const create = async (req, res) => {
  try {
    ...
    if (doctor_name) {
      await createContact(home.id, doctor_name, doctor_email, doctor_phone, "doctor");
    }

    if (family_name) {
      await createContact(home.id, family_name, family_email, family_phone, "family");
    }
...
// UPDATE — replaces contacts entirely
