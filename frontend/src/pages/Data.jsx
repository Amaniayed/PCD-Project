    ...
    <div className="card">
      ...
      <form onSubmit={handleSubmit} className="home-form">
        ...
        <div className="form-actions">
          ...
          {editId && (
            <button type="button" className="btn-ghost" onClick={() => { setEditId(null); setForm(emptyForm); setError(""); }}>
              Cancel
            </button>
          )}
        </div>
      ...
      {loading ? (
        ...
        <div className="table-wrap">
          <table>
            <thead>
              <tr>
                <th>File</th><th>Home</th><th>Duration</th><th>Uploaded</th><th></th>
              </tr>
            </thead>
            <tbody>
              {datasets.map((d) => (
  ...
  return (
    <div className="data-page">
      ...
      <style>{`
        ...
        .field input, .field select { background:#fff; border:1px solid #e2e5ef; border-radius:10px; padding:10px 13px; color:#1e1f2e; font-size:14px; outline:none; font-family:inherit; transition:border-color .2s,box-shadow .2s; }
